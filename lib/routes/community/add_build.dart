  ...
  Future<void> _submitBuild() async {
    ...
    try {
      ...
      final build = PcBuild(
        ...
        price: price,
        rating: widget.buildToEdit?.rating ?? 0.0,
        ratingCount: widget.buildToEdit?.ratingCount ?? 0,
        imageUrl: imageUrl,
        description: _descriptionController.text.trim(),
        ratedBy: widget.buildToEdit?.ratedBy ?? [],
        createdAt: widget.buildToEdit?.createdAt ?? DateTime.now(),
      );
